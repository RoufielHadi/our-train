...
"C:\Program Files (x86)\Dev-Cpp\MinGW64\bin\g++.exe" -c implementasi_pembelian_tiket.c -o implementasi_pembelian_tiket.o
...
"C:\Program Files (x86)\Dev-Cpp\MinGW64\bin\g++.exe" -c dashboard_pembayaran.c -o dashboard_pembayaran.o
...
"C:\Program Files (x86)\Dev-Cpp\MinGW64\bin\g++.exe" -c dashboard_kursi_kereta.c -o dashboard_kursi_kereta.o
...
"C:\Program Files (x86)\Dev-Cpp\MinGW64\bin\g++.exe" -o OurTrain.exe main.o tree_non_biner.o tree_biner.o implementasi_morse.o hash_password.o implementasi_rute_kereta.o implementasi_akun_user.o implementasi_pembayaran.o implementasi_pembelian_tiket.o implementasi_jadwal_kereta.o implementasi_informasi_kereta.o array.o clear.o implementasi_antrian_offline.o implementasi_kursi_kereta.o implementasi_rekapitulasi_keuntungan.o implementasi_riwayat.o linked.o queue.o stack.o time.o databases.o dashboard_authentication.o dashboard_user.o dashboard_admin.o dashboard_cashier.o dashboard_pembayaran.o dashboard_machine.o dashboard_manajemen_kereta.o dashboard_manajemen_jadwal.o dashboard_lihat_jadwal.o dashboard_kursi_kereta.o dashboard_tiket_saya.o implementasi_tiket_saya.o dashboard_manajemen_rute.o dashboard_manajemen_user.o dashboard_akun_saya.o dashboard_rekening_saya.o -L"C:/Program Files (x86)/Dev-Cpp/MinGW64/lib" -L"C:/Program Files (x86)/Dev-Cpp/MinGW64/x86_64-w64-mingw32/lib" -static-libgcc
